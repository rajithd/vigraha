...
<div class="control-group">
    ...
    <div class="controls docs-input-sizes">
        ...
        <div class="input-append date" id="dp1" data-date="12-02-2012" data-date-format="dd-mm-yyyy">
            <input class="dropdown-datepicker" id="startdate" name="startdate" size="16" type="text" value="12-02-2012"
                   readonly="">
    ...
    <div class="controls docs-input-sizes">
      <span class="help-inline">Select Time</span>-->
        <div class="input-append time" id="dp1">
            <input size="16" id="starttime" name="starttime" placeholder="Show as dropdown" class="dropdown-timepicker"
                   type="text"/>
...
<div class="control-group">
    ...
    <div class="controls docs-input-sizes">
        ...
        <div class="input-append date" id="dp2" data-date="12-02-2012" data-date-format="dd-mm-yyyy">
            <input class="dropdown-datepicker" id="enddate" name="enddate" size="16" type="text" value="12-02-2012"
                   readonly="">
            <span class="add-on"><i class="icon-th"></i><!--<img src="Images/calendar.png" width="16"; height="18";/>--></span>
        </div>
...
<div class="control-group">
    ...
    <div class="controls docs-input-sizes">
      <span class="help-inline">Select Time</span>-->
        ...
        <div class="input-append time" id="dp1">
            <input size="16" id="endtime" name="endtime" placeholder="Show as dropdown" class="dropdown-timepicker"
                   type="text"/>
            <span class="add-on"><!--<i class="icon-th"></i>--><img src="resources/Images/clock.png" width="16"
                                                                    height="18"/></span>
        </div>
...
<div class="control-group">
    ...
    <div class="controls docs-input-sizes">
        <input class="span3" id="promotionnumber" name="promotionnumber" type="text"
