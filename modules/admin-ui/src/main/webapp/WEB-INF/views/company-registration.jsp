                            ...
                            <div class="offset1">
                                ...
                                <form:form class="form-horizontal">			<!------------------------ registration form ------------------------------------------->
                                    <fieldset>
                                        ...
                                        <div class="control-group">
                                            <label for="regno" class="control-label">Company Registration No *</label>
                                            <div class="controls docs-input-sizes">
                                        ...
                                        <div class="control-group">
                                            <label for="tele1" class="control-label">Company Tel No 1 *</label>
                                            <div class="controls docs-input-sizes">
                                        ...
                                        <div class="control-group">
                                            <label for="tele2" class="control-label">Company Tel No 2 *</label>
                                            <div class="controls docs-input-sizes">
                                        ...
                                        <div class="control-group">
                                            <label for="email" class="control-label">Company Email Address *</label>
                                            <div class="controls docs-input-sizes">
