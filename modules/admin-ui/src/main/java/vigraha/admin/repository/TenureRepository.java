...
public class TenureRepository {
    ...
    public boolean saveTenure(int id, String companyCode, String tenureName, String startDate,
                                 String startTime, String endDate, String endTime, String basedOnMessage,
                                 String tenureNumber, String cycleTimeName, String cycleTimeValue,
        ...
        int row = jdbcTemplate.update("insert into `tenure` values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)", id, companyCode, tenureName,
                new_start, new_end, basedOnMessage, tenureNumber, cycleTimeName, cycleTimeValue,
