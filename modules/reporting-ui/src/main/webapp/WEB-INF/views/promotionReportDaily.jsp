...
<script src="resources/javaScript/bootstrap-dropdown.js"></script>		<!------------------- DropDown Menu js ----------------------------------------->
...
<script type="text/javascript" src="resources/javaScript/bootstrap.js"></script>			<!------------------------ timepicker js ------------------------>
...
<body>
	...
	<div class="container-fluid">
        ...
        <div class="control-group">
        	<label class="control-label">Promotion Name *</label>
            	<div class="controls docs-input-sizes">
              	<input class="span3" type="text" placeholder="Enter Promotion Name">
            	</div>
       	</div>
       ...
       <div class="control-group">
               <div class="controls">
                  <label class="checkbox">Show report chart<input type="checkbox" id="optionsCheckbox" value="option1"> </label>
