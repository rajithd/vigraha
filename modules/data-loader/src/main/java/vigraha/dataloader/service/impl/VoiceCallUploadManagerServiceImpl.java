...
import vigraha.dataloader.util.VoiceCallTransactionProcessorThread;
...
public class VoiceCallUploadManagerServiceImpl implements UploadManagerService {

    private static final Logger logger = LoggerFactory.getLogger(VoiceCallUploadManagerServiceImpl.class);
    ...
    public void upload() {
        ...
        logger.info("Voice call CDR logs upload scheduler completed");
        ...
        try {
            ...
            while (charBuffer.hasRemaining()) {
                ...
                if (character == rawBreaker.charAt(0)) {
                    pool.execute(new VoiceCallTransactionProcessorThread(builder.toString(),
