...
import vigraha.dataloader.util.SMSTransactionProcessorThread;
...
public class SMSUploadManagerServiceImpl implements UploadManagerService {

    private static final Logger logger = LoggerFactory.getLogger(SMSUploadManagerServiceImpl.class);
    ...
    public void upload() {
        ...
        logger.info("SMS CDR logs upload scheduler completed");
        ...
        try {
            ...
            while (charBuffer.hasRemaining()) {
                ...
                if (character == rawBreaker.charAt(0)) {
                    pool.execute(new SMSTransactionProcessorThread(builder.toString(),
