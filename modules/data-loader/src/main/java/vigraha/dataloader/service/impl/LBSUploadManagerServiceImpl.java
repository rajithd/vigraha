...
import vigraha.dataloader.util.LBSTransactionProcessorThread;
...
public class LBSUploadManagerServiceImpl implements UploadManagerService {

    private static final Logger logger = LoggerFactory.getLogger(LBSUploadManagerServiceImpl.class);
...
//        pool = Executors.newFixedThreadPool(this.poolSize);
    ...
    public void upload() {
        ...
        logger.info("LBS CDR logs upload scheduler completed");
        ...
        try {
            ...
            while (charBuffer.hasRemaining()) {
                ...
                if (character == rawBreaker.charAt(0)) {
                    pool.execute(new LBSTransactionProcessorThread(builder.toString(),
